...
export const slides = [
    ...
    /* --------------------------------------------------- 08b CORE PLATFORM */
    {
        ...
        items: [
            ...
            { icon: 'ChatBubbleLeftRightIcon', title: 'Messaging & study rooms', desc: 'Live 1:1 faculty chat and section-scoped group study rooms — presence, typing, unread counts.' },
    ...
    /* ------------------------------------------------------- 09 STUDENT GRID */
    {
        ...
        items: [
            ...
            { icon: 'UsersIcon', title: 'Study Rooms & Office Hours', desc: 'Live group chats with classmates; book faculty slots in a click.' },
            { icon: 'MagnifyingGlassIcon', title: '⌘K Semantic Search', desc: 'One palette over docs, notes, courses, discussions & chats.' },
            { icon: 'LightBulbIcon', title: 'Notes & Tasks', desc: 'Personal productivity + saved AI answers + .ics calendar sync.' },
        ],
    },
    ...
    /* ------------------------------------------------------------ 19 ROADMAP */
    {
        ...
        shipped: ['Streaming RAG tutor + citations', 'Chat with my materials (personal RAG)', 'AI quiz → proctored exam', 'AI practice quizzes', 'AI-assisted grading', 'At-risk early warning', 'Real-time messaging + study rooms', 'Office-hours booking', '⌘K semantic search', '.ics calendar sync', 'RBAC + audit log', 'Document approval pipeline', 'AI usage governance'],
